$(function () {
    ...
    function feiru() {
        if ((leng - 1) >= i) {
			...
			$('.begin').html('<a href="../html/Memories.html" style="text-decoration: none;color: #fff;background: pink;display: inline-block;padding: 10px;border: 2px solid #fff;">叮！按时长大！</a>');
			$('.begin').fadeIn();
            return;
        }
    };
